...
//                             métodos de la clase CodeAnalyser que analizan un
//                             archivo de texto y almacenan información
//                             relevante en atributos de la clase.
...
public:
  ...
  /// @return Un booleano que será "true" si el programa detectó una funcion
  /// principal.
  bool get_main() const;
