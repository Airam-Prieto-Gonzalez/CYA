...
int main(int argc, char *argv[]) {
  if (argc < 4) {
    ...
    } else if (opcode == "subcadenas") {
      FuncionSubcadenas(cadenas, output_file);
      std::cout << "/// Funcion subcadenas ejecutada con exito." << std::endl;
    } else if (opcode == "subsecuencias") {
      FuncionSubsecuencias(cadenas, output_file);
      std::cout << "/// Funcion subsecuencias ejecutada con exito." << std::endl;
    } else {
