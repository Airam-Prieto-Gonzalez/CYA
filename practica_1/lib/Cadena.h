...
//                              Contiene la declaración de los métodos de la clase Cadena.
...
/// @brief Clase Cadena: representa la sucesion de caracteres basados en un alfabeto
class Cadena {
 public:
  ...
  int longitud() const;
  /// @brief Método que imprime la cadena de forma inversa en el fichero de salida
  /// @param output_file descriptor del fichero de salida donde se escribirán las cadenas inversas
  void inversa(std::ofstream& output_file) const;
  /// @brief Método que imprime los prefijos de la cadena en el fichero de salida
  /// @param output_file Descriptor del fichero de salida donde se escribirán los prefijos
  void prefijos(std::ofstream& output_file) const;
  /// @brief Método que imprime los sufijos de la cadena en el fichero de salida
  /// @param output_file Descriptor del fichero de salida donde se escribirán los sufijos
